...
const unsigned int DefaultLoggingMask = (OIId | RobotLogId | ShooterSubsystemLogId | ConfigurationId | VisionTargetingId | GantrySubsystemLogId | IntakeSubsystemLogId);
